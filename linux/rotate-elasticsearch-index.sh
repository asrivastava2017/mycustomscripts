...
#
#Get all the indexes names from https://search-something.somewhere.es.amazonaws.com/_cat/indices
#Match the ones that containg the string entered
#Find the date in the index name
#Those that have a date older than the days to keep will be deleted
#Any other index will be ignored and kept
#Usage example
